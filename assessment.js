...
var wildNameReturn = (vari) => "wild " + vari;
...
animalSounds('Bryan', 'woof', wildNameReturn);// CODE HERE
...
var shortNames = friends.filter((val)=>val.length<4); // CODE HERE
...
goodPeople.forEach((keyVal)=>keyVal.family = true);// CODE HERE